...
from .views import (
    ...
    add_task, complete_task, uncomplete_task, like, unlike)
...
urlpatterns = [
    ...
    url(r'^like/(?P<pk>[0-9]+)$', login_required(like), name='project_like'),
    url(r'^unlike/(?P<pk>[0-9]+)$', login_required(unlike), name='project_unlike'),
]
